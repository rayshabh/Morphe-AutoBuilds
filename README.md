...
Get the [latest CI release](https://github.com/rayshabh/Morphe-AutoBuilds/releases).
 ...
 * Star the repo :eyes:
 * Use the repo as a [template](https://github.com/new?template_name=Morphe-AutoBuilds&template_owner=rayshabh)
